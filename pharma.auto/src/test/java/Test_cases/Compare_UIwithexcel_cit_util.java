...
public class Compare_UIwithexcel_cit_util {
		WebDriver driver;
	
	Write_exceltocompare_cit_util Rcexcel_cit=new Write_exceltocompare_cit_util();
...
//====================================================Get UI and excel array list and compare==========================================
	public void compareUInExcel()
	{
		...
		ArrayList exlist = Rcexcel_cit.getList();
